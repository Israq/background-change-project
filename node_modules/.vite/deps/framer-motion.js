...
var LayoutGroup = ({ children, id: id5, inherit = true }) => {
  const layoutGroupContext = (0, import_react27.useContext)(LayoutGroupContext);
  const [forceRender, key] = useForceUpdate();
  const context = (0, import_react27.useRef)(null);
  ...
  const memoizedContext = (0, import_react27.useMemo)(() => ({ ...context.current, forceRender }), [key]);
...
var Group = (0, import_react29.forwardRef)(ReorderGroup);
...
function ReorderItem({ children, style = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  ...
  const measuredLayout = (0, import_react31.useRef)(null);
...
var Item = (0, import_react31.forwardRef)(ReorderItem);
...
function useSpring(source, config = {}) {
  ...
  const activeSpringAnimation = (0, import_react32.useRef)(null);
...
function useScroll({ container, target, layoutEffect = true, ...options } = {}) {
  ...
  const useLifecycleEffect = layoutEffect ? useIsomorphicLayoutEffect : import_react34.useEffect;
  useLifecycleEffect(() => {
...
function useMotionValueEvent(value, event, callback) {
  (0, import_react36.useInsertionEffect)(() => value.on(event, callback), [value, event, callback]);
}
